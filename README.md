...
For an exmaple, run `uv run python examples/explore.py` or checkout [datacard.html](https://htmlpreview.github.io/?https://raw.githubusercontent.com/gianlucadetommaso/inga/main/plots/datacard.html).
